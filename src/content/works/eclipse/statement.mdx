...
title: Eclipse
folderName: eclipse
description: La obra se convierte en una sinfonía visual que fusiona arte contemporáneo y reflexiones ambientales.
...
import boceto from '../eclipse/sketch.js?url';
import Lienzo from '@components/Lienzo.astro';

<Lienzo urlSketch={ boceto } ancho="400" alto="400" version="1.9.2" />
