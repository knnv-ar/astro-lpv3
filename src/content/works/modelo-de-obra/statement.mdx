...
folderName: modelo-de-obra
description: Ejemplo de obra para esta galería.
...
import boceto from '../modelo-de-obra/sketch.js?url';
import Lienzo from '@components/Lienzo.astro';

<Lienzo client:load urlSketch={ boceto } ancho="512" alto="512" version="1.9.2" />
