...
description: La obra trata de un operador que crea una alegoria a los movimientos de vanguardia. El recorrido avanza y crea nuevos caminos, rompiendo los anteriores.
...
import boceto from '../artefacto/sketch.js?url';
