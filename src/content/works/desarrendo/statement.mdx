---
title: Desarrendo
folderName: desarrendo
description: El título implica un juego de palabras en francés entre las palabras "désordres" (desorden) y "des ordres" (algunas órdenes), lo que sugiere que puede haber alguna razón oculta detrás del desorden superficial.
...
import boceto from '../desarrendo/sketch.js?url';
