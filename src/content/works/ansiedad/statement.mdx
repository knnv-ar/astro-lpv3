...
title: Ansiedad
folderName: ansiedad
description: Representación de la ansiedad. Un poco de dolor, un poco de desesperación, grito, enojo, sentir como las tripas de enriendan.
...
import boceto from '../ansiedad/sketch.js?url';
